                ...
                <div class="payment margin-top-30">
                    ...
                    <div class="payment-tab payment-tab-active">
                        <div class="payment-tab-trigger">
                            ...
                            <img class="payment-logo {PAYMENT_TYPES.folder}" src="{SITE_URL}includes/payments/{PAYMENT_TYPES.folder}/logo/logo.png" alt="{PAYMENT_TYPES.title}">
                        </div>
                    ...
                    {:IF}
                        ...
                        <div class="payment-tab">
                            <div class="payment-tab-trigger">
                                <input name="payment_method_id" class="payment_method_id" id="{PAYMENT_TYPES.folder}" type="radio" value="{PAYMENT_TYPES.id}" data-name="ccavenue">
                                <label for="{PAYMENT_TYPES.folder}">{PAYMENT_TYPES.title}</label>
                                <img class="payment-logo {PAYMENT_TYPES.folder}" src="{SITE_URL}includes/payments/{PAYMENT_TYPES.folder}/logo/logo.png" alt="">
                            </div>
                            ...
                            <div class="row payment-form-row">
                                <div class="col-12">
                                    <div class="card-label form-group">
                                        <input type="text" class="form-control" name="stripeCardNumber" placeholder="{LANG_CARD_NUMBER}" autocomplete="cc-number"  autofocus/>
                                    </div>
                                </div>
                                <div class="col-7">
                                    <div class="card-label form-group">
                                        <input type="tel" class="form-control" name="stripeCardExpiry" placeholder="MM / YYYY" autocomplete="cc-exp" />
                                    </div>
                                </div>
                                <div class="col-5 pull-right">
                                    <div class="card-label form-group">
                                        <input type="tel" class="form-control" name="stripeCardCVC" placeholder="CVV" autocomplete="cc-csc" />
                                    </div>
                                </div>
                    ...
                    <div class="payment-tab">
                        ...
                        <div class="payment-tab-content">
                            ...
                            <div class="row payment-form-row">
                                <div class="col-12">
                                    <div class="card-label form-group">
                                        <input type="text" class="form-control" name="checkoutCardNumber" placeholder="{LANG_CARD_NUMBER}" autocomplete="cc-number"  autofocus/>
                                    </div>
                                </div>
                                <div class="col-7">
                                    <div class="card-label form-group">
                                        <input type="tel" class="form-control" name="checkoutCardExpiry" placeholder="MM / YYYY" autocomplete="cc-exp" aria-required="true" aria-invalid="false">
                                    </div>
                                </div>
                                <div class="col-5 pull-right">
                                    <div class="card-label form-group">
                                        <input type="tel" class="form-control" name="checkoutCardCVC" placeholder="CVV" autocomplete="cc-csc" />
                                    </div>
                                </div>
                                <div class="col-7">
                                    <div class="card-label form-group">
