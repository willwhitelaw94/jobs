                                    ...
                                    <div class="payment-tab-content">
                                        ...
                                        <div class="row premium-plans">
                                            ...
                                            <div class="col-lg-3 premium-plans-price">
                                                {USER_CURRENCY_SIGN}{FEATURED_FEE} {LANG_FOR} {FEATURED_DURATION} {LANG_DAYS}
                                            </div>
                                        </div>
                                        <div class="row premium-plans">
                                            <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-3 premium-plans-price">
                                                {USER_CURRENCY_SIGN}{URGENT_FEE} {LANG_FOR} {URGENT_DURATION} {LANG_DAYS}
                                            </div>
                                        </div>
                                        <div class="row premium-plans">
                                            <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-3 premium-plans-price">
                                                {USER_CURRENCY_SIGN}{HIGHLIGHT_FEE} {LANG_FOR} {HIGHLIGHT_DURATION} {LANG_DAYS}
                                            </div>
                                        </div>
                                    </div>
                                </div>
