...
<head>
    ...
    <link rel="stylesheet" href="{SITE_URL}plugins/quickchat-ajax/assets/bootstrap/dist/css/bootstrap.min.css">
                            ...
                            <div class="header-notifications-dropdown">
                                ...
                                <div class="user-status">
                                    ...
                                    <div class="user-details">
                                        <div class="user-avatar status-online"><img src="{SITE_URL}storage/profile/{AVATAR}" alt=""></div>
                                        <div class="user-name">
                                            {USERNAME} <span>{USERTYPE}</span>
                                        </div>
                                    </div>

                                    <!-- User Status Switcher -->
                                    <div class="status-switch" id="snackbar-user-status">
                                        <label class="user-online IF({VISIBILITY}){current-status{:IF}" data-visibilty="1">{LANG_ONLINE}</label>
                                        <label class="user-invisible IF(!{VISIBILITY}){current-status{:IF}" data-visibilty="0">{LANG_OFFLINE}</label>
                                        <!-- Status Indicator -->
                                        <span class="status-indicator IF(!{VISIBILITY}){right{:IF}" aria-hidden="true"></span>
                                    </div>
                                </div>
