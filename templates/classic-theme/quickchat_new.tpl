    ...
    <div class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-9 col-md-12 ">
				<div class="row">
						<div class="col-lg-9 col-md-12" id="chat_section">
							<div id="wchat">
						...
						<div class="col-lg-12 d-none" id="agreement_form_section">
							<div class="dashboard-box mt-0">
								<!-- Headline -->
								<div class="headline">
									<h3><span class="back-btn"><i class="icon-feather-arrow-left"></i> Back</span></h3>
								</div>
								<div class="content with-padding ">
									<form method="post" accept-charset="UTF-8" enctype="multipart/form-data" id="agreement-form">
										...
										<div class="agreed_services_cl">
											<div class="row">
												<div class="col-lg-12">
													<div class="submit-field m-b-0">
														<h5>Agreed Services <span class="required">*</span></h5>
														<p>For example "Monday from 9am-12pm,from 20th March. Cleaning,preaparing lunch and assistance with showering".</p>
														<textarea placeholder="" rows="" name="agreed_services"></textarea>
													</div>
												</div>
												<div class="col-lg-12 last_sec_check">
													<h5>Information Sharing <span class="required">*</span></h5>
													<p>The client is self-managed by through Trilogy Care.</p>
													<div class="checkbox">
														<input type="checkbox" id="chekcbox1" value="1" name="info_sharing">
														<label for="chekcbox1"><span class="checkbox-icon"></span> I understand that document on my profile, including my policy check, will now be made available to Trilogy Care.</label>
														<label for="info_sharing" id="info_sharing-error" class="error"></label>
										...
										<div class="two_btn_wrap">
											...
											<div>
												<button type="submit" name="submit" class="button ripple-effect">Offer an agreement to <span class="chat_user_name"></span></button>
											</div>
										</div>
									</form>
								</div>
...
<script>
    ...
    var CHAT_FULLNAME = "{CHAT_FULLNAME}";
    var CHAT_USERIMG = "{CHAT_USERIMG}";
    var CHAT_USERSTATUS = "{CHAT_USERSTATUS}";
...
$(document).ready(function() {
		...
		$agreementForm.validate({
			...
			messages: {
				agreed_services: {
					required: "Please enter agreed service details"
				},
				info_sharing: {
					required: "You Must check information sharing checkbox"
				},
			},
		...
		$agreementForm.on("blur", "input,textarea", function(e){
			$agreementForm.validate();
			$form.element(this)
		});
