     ...
     <div class="container">
            <div class="row">
                  ...
                  <div class="col-lg-9 col-md-12 ">
                        ...
                        IF("{USERTYPE}"=="user"){
                        <div class="d-none dashboard-box  mt-0 active">
                              <!-- Headline -->
                              <div class="headline">
                                    <h3><i class="icon-feather-arrow-left"></i> Back</h3>
                              </div>
                              <div class="content with-padding ">
                                    <form method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                                          <div class="row">
                                                <div class="col-12" >
                                                      <h4>Offer an new agreement to <span id="chat_user_name"></span></h4>
                                                      <p>You must send an agrrement to peter and wait for them to accept before you can start providing care.</br>
                                          ...
                                          <div class="row">     
                                                <div class="col-12">
                                                      <div class="submit-field mb-0">
                                                            ...
                                                            <div class="input-with-icon-left">
                                                                  <input type="text" class="with-border" id="" name="description"  value="" onBlur="">
                                                            </div>
                                                            <span id="error"></span>
                                                      </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                      <div class="submit-field">
                                                            <h5>Agreed Rate</h5>
                                                            <small>Including 10% worker invoice fees</small>
                                                            <div class="input-with-icon-left no-border">
                                                            <i class="icon-feather-dollar-sign"></i>
                                                            <input type="number" class="with-border margin-bottom-0" name="agr_rate" value="25">                                                            
                                                            </div>
                                                      </div>
                                                </div>
                                                <div class="col-xl-9 col-md-9">
                                                      <div class="submit-field">
                                                            <div class="radio margin-right-20">
                                                                <input class="with-gap" type="radio" name="rate_type" id="per_hour" value="per_hour" checked/>
                                                                <label for="per_hour"><span class="radio-label"></span>Per Hour</label>
                                                            </div>
                                                            <div class="radio margin-right-20">
                                                                <input class="with-gap" type="radio" name="rate_type" id="flat_rate" value="flat_rate" />
                                                                <label for="flat_rate"><span class="radio-label"></span>Flat Rate</label>
                                                            </div>
                                                      </div>
                                                </div>
                                                <p><i class="icon-feather-alert-circle"></i> Net Rate you will be paid 10</p>
                                          </div>
