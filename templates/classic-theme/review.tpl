            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="dashboard-box margin-top-0">
                        ...
                        <!-- Headline -->
                        <div class="headline">
                            <h3><i class="icon-material-outline-business"></i> Reviews of me</h3>
                        </div>
                        ...
                        <div class="content">
                            <ul class="dashboard-box-list">
                                ...
                                <li>
                                    ...
                                    <a href="#small-dialog-1" class="popup-with-zoom-anim button gray ripple-effect margin-top-5 margin-bottom-10"><i class="icon-feather-edit"></i> Challenge Review</a>
                                </li>
                                <li>
                                    <div class="boxed-list-item">
                                        <!-- Content -->
                ...
                <div class="col-xl-6">
                    <div class="dashboard-box margin-top-0">
                        ...
                        <!-- Headline -->
                        <div class="headline">
                            <h3><i class="icon-material-outline-face"></i> My Reviews</h3>
                        </div>
