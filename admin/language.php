    ...
    <div class="container-fluid p-y-md">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="#" data-url="panel/userlanguage_add.php" data-toggle="slidePanel" class="btn btn-success waves-effect waves-light m-r-10">Add Language</a>
                </div>
            </div>
            <div class="card-block">
                <div id="js-table-list">
                    <table class="js-table-checkable table table-vcenter table-hover" id="ajax_datatable" data-jsonfile="language.php">
                        <thead>
                        <tr>
...
<div class="site-action">
    ...
    <div class="site-action-buttons">
        <button type="button" data-ajax-response="deletemarked" data-ajax-action="deleteUserLanguage"
