                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_signup_details" rows="10" class="form-control" placeholder="Enter Message"><?php echo stripcslashes(nl2br(get_option("email_message_signup_details"))) ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_signup_confirm" rows="10" class="form-control" placeholder="Enter Message"><?php echo stripcslashes(nl2br(get_option("email_message_signup_confirm"))) ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_forgot_pass" rows="10" class="form-control" placeholder="Enter Message"><?php echo stripcslashes(nl2br(get_option("email_message_forgot_pass"))) ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_contact" rows="10" class="form-control" placeholder="Enter Message"><?php echo stripcslashes(nl2br(get_option("email_message_contact"))) ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_feedback" rows="10" class="form-control" placeholder="Enter Message"><?php echo stripcslashes(nl2br(get_option("email_message_feedback"))) ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_report" rows="10" class="form-control" placeholder="Enter Message"><?php echo stripcslashes(nl2br(get_option("email_message_report"))) ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_ad_approve" rows="10" class="form-control" placeholder="Enter Message"><?php echo stripcslashes(nl2br(get_option("email_message_ad_approve"))) ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_re_ad_approve" rows="10" class="form-control" placeholder="Enter Message"><?php echo stripcslashes(nl2br(get_option("email_message_re_ad_approve"))) ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_contact_seller" rows="10" class="form-control" placeholder="Enter Message"><?php echo stripcslashes(nl2br(get_option("email_message_contact_seller"))) ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <table
                                                                                            ...
                                                                                            <tr>
                                                                                                <td><input value="{SENDER_PROFILE}" readonly="readonly" onclick="this.select()">- Sender Profile Link</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td><input value="{RESUME_LINK}" readonly="readonly" onclick="this.select()">- Resume Download Link</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                ...
                                                                                <div class="quickad-flexbox">
                                                                                    ...
                                                                                    <div class="quickad-flex-cell quickad-vertical-middle">
                                                                                        <a role="button" class="panel-title quickad-js-service-title collapsed" data-toggle="collapse" data-parent=".panel-group" href="#service_9" aria-expanded="false" aria-controls="service_9">
                                                                                            Send new job notification to subscriber </a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_post_notification" rows="10" class="form-control" placeholder="Enter Message"><?php echo stripcslashes(nl2br(get_option("email_message_post_notification"))) ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
