...
$info = ORM::for_table($config['db']['pre'].'about_mes')->find_one($abId);
$c_option = ORM::for_table($config['db']['pre'].'about_me_options')->table_alias('ab_opt')
->select_many('ab_opt.id','ab_opt.name')
->left_outer_join($config['db']['pre'].'about_mes','ab_opt.about_me_id=c_back.id','c_back')
->where('c_back.id',$abId)
->find_array();
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <form name="form2"  class="form form-horizontal" method="post" data-ajax-action="editAboutMe" id="sidePanel_form">
                        <div class="form-body">
