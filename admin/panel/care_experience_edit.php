...
$ceId = isset($_GET['id'])? $_GET['id'] : "";

$info = ORM::for_table($config['db']['pre'].'care_experiences')->find_one($ceId);
$c_option = ORM::for_table($config['db']['pre'].'care_experience_options')->table_alias('ce_opt')
->select_many('ce_opt.id','ce_opt.name')
->left_outer_join($config['db']['pre'].'care_experiences','ce_opt.care_experience_id=ce_back.id','ce_back')
->where('ce_back.id',$ceId)
->find_array();
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <form name="form2"  class="form form-horizontal" method="post" data-ajax-action="editCareExperience" id="sidePanel_form">
                        <div class="form-body">
