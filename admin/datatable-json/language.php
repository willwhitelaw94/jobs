...
foreach ($queryRecords as $row) {
    ...
    $row3 = '<td class="hidden-xs">'.$type.'</td>';
    $row4 = '<td class="text-center">
        <div class="btn-group">
            <a href="#" data-url="panel/userlanguage_edit.php?id='.$id.'" data-toggle="slidePanel" class="btn btn-xs btn-default"> <i class="ion-edit"></i> Edit</a>
            <a href="javascript:void(0)" class="btn btn-xs btn-default item-js-delete" data-ajax-action="deleteUserLanguage"><i class="ion-close"></i></a>
        </div>
    </td>';
    $value = array(
        "DT_RowId" => $id,
